...
<body>
    <?php
        ...
        $board_num = $_GET['num'];
        $board = "SELECT * FROM acebed_board WHERE num = ". $board_num; 
                ...
                <div class="inner">
                    <div class="view_top">
                        <div class="title_view">
                            <?php
                            echo "제목 : " . $item_title . "<br>";
                            echo "날짜 : " . $item_date . "<br>";
                            ?>
                        </div>
                        <div class="sns_view">
                            <a href="">공유하기</a>
                    ...
                    <?php
                            echo $item_num ."<br>";
                            echo "이름 : " . $item_name . "<br>";
                            echo "본문 : " ;
                            echo nl2br($item_desc);
                            echo "<br>";
                    ?>
                </div>
            </div>
