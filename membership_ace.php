...
<head>
    ...
    <link rel="stylesheet" href="css/membership_aceHF.css">
    <link rel="stylesheet" href="css/sub_membership.css">
</head>
<body>
    <?php
        ...
        $tel = $_POST['tel'];
        $email = $_POST['email'];
        $hashedPassword = password_hash($_POST['pw'], PASSWORD_DEFAULT,["cost"=>5]);
        $pw_pr = $_POST['pw_pr'];

        include "connect2.php"; //다른 파일을 연결 할때 사용 (include)
        mysqli_query($conn,"INSERT INTO acebed_join (id, tel, email, passward)
        VALUES ('$name' , '$tel' , '$email' , '$hashedPassword')");
            ...
            <article class="txt_wrap">
                ...
                <div class="join_txt">
                    <form>
                        ...
                        <div class="agree">
                            <a href="login_ace.html" class="dedicated4"> 로그인하기 </a>
                            <a href="membership_ace.html" class="dedicated5"> 돌아가기 </a>
                        </div>
                    </form>
                </div>
            </article>
